...
- `index.html`：以《放开那个女巫》实时官网开场的个人简历与作品集首页
...
页面采用“作品先说话”的系统策划档案式结构：首屏直接实时渲染《放开那个女巫》项目官网，再进入个人定位、完整项目拆解与本机项目谱系。真实游戏画面、可运行 Demo、产品判断和落地证据并列呈现。
...
- 半透明实时项目首屏、CSS 景深与滚动进入动效，并适配低动效偏好
